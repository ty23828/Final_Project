#ERA5 reanalysis (~25km, atmospheric parameters): https://cds.climate.copernicus.eu/datasets/derived-era5-single-levels-daily-statistics?tab=overview
#Sub-region extraction for Portugal
# Reanalysis
...
for year in range(2017, 2018):
    ...
    for month in range(1, 13):
        ...
        # Create filename
        filename = f"era5_daily_max_temp_{year}_{month:02d}.nc"
